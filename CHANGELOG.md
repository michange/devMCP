...
- **skills**: `dialogue.skill.md` and `lisibilite.skill.md` join the corpus, and `skills/cycles/` declares `cyPhases` and `cyBuild`. `cyBuild` links the fifteen step skills of `build/` rather than copying them.
